...
template <typename scalar_t>
void WaveLUT_transform_4d_cpu_forward_impl(
        const int n,
...
template <typename scalar_t>
void WaveLUT_transform_4d_cpu_backward_impl(
        const int n,
...
void WaveLUT_transform_cpu_forward(
    ...
    for (int elt = 0; elt < batch_size; ++elt) {
        AT_DISPATCH_FLOATING_TYPES(
            input.scalar_type(), "WaveLUT_transform_4d_cpu_forward", ([&] {
                ...
                WaveLUT_transform_4d_cpu_forward_impl(
...
void WaveLUT_transform_cpu_backward(
    ...
    for (int elt = 0; elt < batch_size; ++elt) {
        AT_DISPATCH_FLOATING_TYPES(
            input.scalar_type(), "WaveLUT_transform_4d_cpu_backwar", ([&] {
                ...
                WaveLUT_transform_4d_cpu_backward_impl(
